...
- 금일 날짜(2022-01-12) 기준으로 [GitHub](https://github.com/ljlm0402/typescript-express-starter) [Star: 977개](https://github.com/ljlm0402/typescript-express-starter/stargazers), [Fork: 147](https://github.com/ljlm0402/typescript-express-starter/network/members)를 보유하고 있습니다.

- [npm](http://npm.im/typescript-express-starter) 패키지로 v7.0.0 배포한 상태입니다.
...
그러나, ES6부터 클래스형([Class](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Classes))이 등장하면서 나오면서 관심을 갖고
...
> 출처
>
> <a href="https://url.kr/1dfx75" target="_blank">견고한 node.js 프로젝트 설계하기</a>
> <a href="https://url.kr/13ctyz" target="_blank">Bulletproof node.js project architecture</a>
> <a href="https://url.kr/hks6ar" target="_blank">Route-Controller-Service structure for ExpressJS</a>
